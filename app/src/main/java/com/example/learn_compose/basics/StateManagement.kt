...
fun StateManagementexample(modifier: Modifier = Modifier) {
    ...
    //mutable holds the value  that can change
    //& trigers recomposition when the value changes
...
fun RememberSaveableExample(modifier: Modifier = Modifier) {
    //remeberseavable saves the state during configuration changes
...
@Composable
fun StateHostingExample(modifier: Modifier = Modifier) {
