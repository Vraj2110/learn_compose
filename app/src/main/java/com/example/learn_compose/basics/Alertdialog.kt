    ...
    Column(
        ...
        Card(
            ...
            Row(
                ...
                IconButton(
                    onClick = {openDialog = true}, colors = IconButtonDefaults.iconButtonColors(
...
//                },
                ...
                text = { Text(text = "are u sure want to delete this item? ") },
                confirmButton = {
                    Button(
                        onClick = {
                            Toast.makeText(context,"Item has been deleted successfully",Toast.LENGTH_SHORT)
                                .show()
